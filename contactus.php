        ...
        <form>
          ...
          <div class="form-group mb-6">
            <input type="email" class="form-control block
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="emailadd"
          ...
          <div class="form-group form-check text-center mb-6">
            ...
            <label class="form-check-label inline-block text-gray-800 dark:text-white" for="exampleCheck87">Send me a copy of this
              message</label>
          </div>
